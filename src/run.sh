# python train.py config/train/train_lr1e3.yaml
# python train.py config/train/train_lr1e4.yaml
# python train.py config/train/train_few_shot_lr1e3.yaml
# python train.py config/train/train_few_shot_lr1e4.yaml

# python train.py config/train/train_lr1e3_mlp.yaml
# python train.py config/train/train_lr1e4_mlp.yaml

# python train.py config/linear/linear2.yaml
# python train.py config/linear/linear3.yaml

# python train.py config/train/train_lr1e3_mlp3.yaml
# python train.py config/train/train_lr1e4_mlp3.yaml

# python train.py config/linear/linear4.yaml
# python train.py config/linear/linear5.yaml
...
python train.py config/fewshot/supervise_meta_euc_res12.yaml
python train.py config/fewshot/supervise_meta_euc_noaug_res12.yaml